...
| D-048 | Keep a comprehensive demands table and revise when incomplete | Done (this revision) | This revised table expands missing items and preserves status rationale. |
